...
#    def get_inputs(self, contracts, date_from, date_to):
    def get_inputs(self, contracts, date_from, date_to):
        ...
        amount = 0        
        input_twd_01 = 'INPUT_TWD_01'
        amount = self.get_input_code(input_twd_01')
        res.append({
            'name': 'Total Working Day-1st Half',
            'code': input_twd_01,
            'amount': amount,
    ...
    def get_input_code(self, input_code):
        ...
        sql = """select x_twd_1st from aag_group_calendar_aag_group_calendar where x_wrkgrp=%s and month=%s and year=%s"""
